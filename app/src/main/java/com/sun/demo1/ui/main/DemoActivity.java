...
import com.sun.base.http.DownLoadManager;
import com.sun.base.http.download.ProgressCallBack;
import com.sun.base.util.ToastUtil;
import com.sun.demo1.BR;
import com.sun.demo1.R;
import com.sun.demo1.databinding.ActivityDemoBinding;
        ...
        rxPermissions.request(Manifest.permission.CAMERA)
                .subscribe(new Consumer<Boolean>() {
                    ...
                    public void accept(Boolean aBoolean) throws Exception {
                        if (aBoolean) {
                            ToastUtil.showShort("相机权限已经打开，直接跳入相机");
                        } else {
